...
$folder = new Folder();
$result = $folder->addChatToFolder($folderId, $chatId, $user['user_id']);

if (!$result) {
    http_response_code(400);
    echo json_encode(['error' => 'Не удалось добавить чат в папку']);
    exit;
}

// Возвращаем успешный ответ
header('Content-Type: application/json');
echo json_encode(['success' => true, 'message' => 'Чат успешно добавлен в папку']);
